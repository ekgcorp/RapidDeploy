...
using RapidDeploy.Services.SettingsServices;
using RapidDeploy.Services.MapService;
...
namespace RapidDeploy
{
    ...
    sealed partial class App : BootStrapper
    {
        public App()
        {
            ...
            // Active Logging by Uncommenting this line
        ...
        public override async Task OnStartAsync(StartKind startKind, IActivatedEventArgs args)
        {
            ...
            await NavigationService.NavigateAsync(typeof(Views.MainPage), 1);
        }
